...
import { CircleUserRound, CreditCard, HandCoins, ListChecks, Package, Settings } from "lucide-react";
    ...
    <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6">
      <div className="grid gap-8 lg:grid-cols-[290px_1fr]">
        <aside className="space-y-5">
          <div className="rounded-[30px] border border-emerald-100 bg-white p-5 shadow-[0_14px_34px_rgba(15,23,42,0.05)]">
            <p className="text-xs font-bold uppercase tracking-[0.24em] text-[#16a34a]">Account</p>
            <p className="mt-3 text-2xl font-black text-slate-950">Manage your CouponX profile</p>
        ...
        <section className="space-y-6">
          <div className="rounded-[30px] border border-emerald-100 bg-white p-6 shadow-[0_14px_34px_rgba(15,23,42,0.05)] sm:p-8">
