                ...
                <div className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <div ref={notificationRef} className="relative">
                      ...
                      {notificationOpen ? (
                        <div className="admin-content-surface absolute right-0 top-[calc(100%+10px)] z-[70] min-w-[320px] rounded-2xl border border-slate-200 bg-white p-3 shadow-[0_18px_44px_rgba(15,23,42,0.08)]">
