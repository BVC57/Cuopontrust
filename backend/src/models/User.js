...
const userSchema = new mongoose.Schema(
  {
    ...
    rewardWalletBalance: { type: Number, default: 0 },
    rewardLevel: { type: String, default: "Bronze" },
    lastSpinDate: Date,
    lastRewardLoginDate: Date,
    loginStreak: { type: Number, default: 0 },
    lastLoginRewardAt: Date,
    isRewardBlocked: { type: Boolean, default: false, index: true },
